...
namespace ChaosAge.Battle
{
    public class Battle : MonoBehaviour
    {
        ...
        public List<BattleBuildingData> _buildings = new List<BattleBuildingData>();
        ...
        //-========================================================
        public void Initialize(List<BattleBuildingData> buildings, DateTime time, AttackCallback attackCallback = null, FloatCallback destroyCallback = null, FloatCallback damageCallback = null) // ok
        {
            baseTime = time;
            frameCount = 0;
            percentage = 0;
